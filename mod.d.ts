...
* @returns accessed value
*/
type TernaryCallback = ( value: any, idx: number, indices: Array<number> ) => any;
...
* @returns accessed value
*/
type QuaternaryCallback = ( value: any, idx: number, indices: Array<number>, arrays: Array<ndarray> ) => any;
...
* @returns accessed value
*/
type Callback = NullaryCallback | UnaryCallback | BinaryCallback | TernaryCallback | QuaternaryCallback;
...
*/
declare function unaryBy( arrays: ArrayLike<ndarray>, fcn: Unary, clbk: Callback, thisArg?: any ): void;
